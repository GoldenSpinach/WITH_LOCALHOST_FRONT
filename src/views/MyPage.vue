<template>
  ...
  <div class="w-full h-screen flex flex-col items-center justify-center">
    <section class="w-5/6 max-w-[1160px] h-[700px] border rounded-lg box-border p-[25px] self-center">
      <div class="flex w-full h-full pt-[45px] box-border">
        <div class="w-1/4 flex flex-col items-center gap-[15px]">
          ...
          <button class="bg-blue-400 w-3/6 text-white h-[35px] rounded-lg cursor-pointer">
            관광객 전환
          </button>
