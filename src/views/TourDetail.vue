          ...
          <div class="w-[45%]">
            ...
            <div class="flex flex-col gap-[8px] max-h-[700px] overflow-y-auto">
              <div
                ...
                v-for="activity in detail.activitys" :key="activity.actId">
                {{ activity.actName }}
              </div>
            </div>
          </div>
      ...
      <div class="flex flex-col items-center w-[40%]">
        <div>
          <Datepicker v-model="selectedDate" :inline="true" :allowed-dates="allowedDates"
            style="--dp-cell-size: 100px; --dp-cell-padding: 35px; --dp--flex-display: 0" />
        </div>
        <div class="w-full justify-around flex mt-[25px]">
          <button class="w-[35%] h-[45px] bg-blue-400 text-white rounded-lg ">예약하기</button>
          <button class="w-[35%] h-[45px] bg-blue-400 text-white rounded-lg ">문의하기</button>
        </div>
      </div>
    </div>
    <div class="w-full flex items-center justify-around">
